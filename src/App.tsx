  ...
  return (
    <SiteLayout>
      <div className={'flex flex-col'}>
        ...
        <div id="specsSection" className={'flex flex-col md:flex-row bg-[#f4e8b7] text-slate-700'}>
          <StudioSpecs />
          <img className={'object-cover'} src={StudioImage} alt='Image of home studio'/>
        </div>
        <a id="about"></a><div id="resumeSection" className={'flex flex-col space-y-4 pb-10 border-x border-neutral-600'}>
          <h2 className={'text-center text-4xl mt-8 mb-6'}>Resume</h2>
