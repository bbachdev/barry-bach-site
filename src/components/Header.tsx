    ...
    <header className={'max-w-7xl max-h-20 md:max-h-24 md:h-24 mx-auto px-4 py-2 flex flex-row text-md items-center'}>
      ...
      <div className={`${isMenuOpen ? 'flex' : 'hidden'} md:hidden flex-col bg-[#242424] space-y-4 absolute py-2 top-20 right-0 w-full h-fit z-20 transition-all`}>
        ...
        <ul className={'flex flex-row space-x-5 items-center mx-auto py-4'}>
          <li>
            <a href={'https://bsky.app/profile/barrybach.com'} target={'_blank'} onClick={toggleMenu} aria-label='Go to Bluesky profile'>
          ...
          <li>
            <a href={'https://www.instagram.com/barry__bach'} target={'_blank'} onClick={toggleMenu} aria-label='Go to Instagram profile'><InstagramIcon fontSize={'large'} /></a>
          </li>
          <li>
            <a href={'https://www.youtube.com/channel/UC2_ONiCusUKZ85yqGMNKgJg'} target={'_blank'} onClick={toggleMenu} aria-label='Go to YouTube channel'><YouTubeIcon fontSize={'large'} /></a>
          </li>
          <li>
            <a href={'mailto:contact@barrybach.com'} target={'_blank'} onClick={toggleMenu} aria-label='Contact via email'><EmailIcon fontSize={'large'} /></a>
          </li>
        </ul>
      </div>
      ...
      <div className={'ml-8 hidden md:flex flex-row items-center'}>
        <ul className={'flex flex-row space-x-5'}>
          ...
          <li>
            <a href={'https://www.instagram.com/barry__bach'} target={'_blank'}><InstagramIcon fontSize={'large'} aria-label='Go to Instagram profile' /></a>
          </li>
          <li>
            <a href={'https://www.youtube.com/channel/UC2_ONiCusUKZ85yqGMNKgJg'} target={'_blank'}><YouTubeIcon fontSize={'large'} aria-label='Go to YouTube channel' /></a>
          </li>
          <li>
            <a href={'mailto:contact@barrybach.com'} target={'_blank'}><EmailIcon fontSize={'large'} aria-label='Contact via email' /></a>
          </li>
        </ul>
      </div>
    </header>
